...
const Navbar = () => {
  ...
  //useEffect to show login state chnge
    useEffect(() => {
    try {
    ...
    <nav className={navbarStyles.nav}>
        ...
        <div className={navbarStyles.titleContainer}>
            <div className={navbarStyles.titleBackground}>
                <h1 className={navbarStyles.titleText}>BrainBuzz Quiz Application</h1>
            </div>
        </div>
            ...
            <ul className={navbarStyles.mobileMenuList}>
              ...
              {loggedIn ? (
                ...
                <li>
                  ...
                  <LogIn className={navbarStyles.mobileMenuIcon}/>Login </NavLink>
                </li>
              )}
            </ul>
          </div>
